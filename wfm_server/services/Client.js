...
function DeleteClient(msg, callback){
	console.log("In Server ClientDetails2");
	var res = {};
	var qry1="delete from Guard where Client_ID='"+msg.id+"';delete from building where Client_ID='"+msg.id+"';delete from alertsraised where Client_ID='"+msg.id+"';	delete from building_requests where Client_ID='"+msg.id+"';delete from guardposition where Client_ID='"+msg.id+"';delete from Clients where Client_SSN='"+msg.id+"' ; delete from Person where SSN='"+msg.id+"'";
...
function requestbuildingform(msg, callback){
	...
	var res = {};
	var qry = "insert into building_requests values('"+msg.id+"','"+msg.bname+"','"+msg.coordinates01+"','"+msg.coordinates11+"','"+msg.coordinates21+"','"+msg.coordinates31+"','"+msg.description+"',"+msg.reqfulfilled+")";
