							...
							mysql.handle_database(function(err,results){
								...
								if(err){
									...
									if(msg.type == 2){
										...
										console.log(date);
										var sqlInsertClient = "insert into Clients (Client_SSN,Start_Date) values ('"+msg.ssn+"','"+date+"')";
										mysql.handle_database(function(err,results){
											console.log("inside");
											if(err){
												console.log("error");
										...
										var date= new Date(Date.now());
										console.log(date);
										var sqlInsertClient = "insert into guard (Guard_ID,DateOfJoining) values ('"+msg.ssn+"','"+date+"')";
										mysql.handle_database(function(err,results){
											console.log("inside");
											if(err){
												console.log("error");
